...
<body>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <?php
                                            ...
                                            if($id!=null && $name)
                                            {
                                                echo "<b style='color:white;'> Xin chào, ". $name . "</b>";
                                        ?>
    ...
    <div class="review-payment">
        <h2 class="title text-center">Đặt phòng thành công</h2> <br>
           <a href="{{URL::to('/')}}" style="margin-left: 675px;">Quay lại trang chủ</a></h2>
        </div>
    </section>
    <!-- Rooms Section End -->
